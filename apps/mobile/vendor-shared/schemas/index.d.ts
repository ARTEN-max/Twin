...
declare const RecordingStatus: z.ZodEnum<
  ['pending', 'uploaded', 'processing', 'complete', 'failed']
>;
...
>;
declare const createRecordingSchema: z.ZodObject<
  Omit<
    {
      id: z.ZodString;
      userId: z.ZodString;
...
>;
declare const createTranscriptSchema: z.ZodObject<
  Omit<
    {
      id: z.ZodString;
      recordingId: z.ZodString;
...
>;
declare const createDebriefSchema: z.ZodObject<
  Omit<
    {
      id: z.ZodString;
      recordingId: z.ZodString;
...
declare const createJobSchema: z.ZodObject<
  Omit<
    ...
    'id' | 'status' | 'createdAt' | 'error' | 'updatedAt'
  >,
  'strip',
  z.ZodTypeAny,
  {
