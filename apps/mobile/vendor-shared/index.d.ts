 ...
 */
declare function createRecording(
  userId: string,
 ...
 */
declare function uploadRecordingFile(
  userId: string,
  recordingId: string,
 ...
 */
declare function completeUpload(
  userId: string,
  recordingId: string,
 ...
 */
declare function getRecordingStatus(
  userId: string,
  recordingId: string
 ...
 */
declare function getRecordingResult(
  userId: string,
  recordingId: string
 ...
 */
declare function listRecordingsByDay(
  userId: string,
 ...
 */
declare function listRecordings(
  userId: string,
 ...
 */
declare function retryTranscription(
  userId: string,
  recordingId: string
): Promise<{
  recordingId: string;
 ...
 */
declare function enrollVoiceProfile(
  userId: string,
  audioBlob: Blob,
  mimeType?: string
): Promise<{
 ...
 */
declare function deleteRecordingApi(
  userId: string,
  recordingId: string
): Promise<{
  ok: boolean;
 ...
 */
declare function registerPushToken(
  _userId: string,
  token: string
): Promise<{
  success: boolean;
