...
const navigation = [
  ...
  { name: 'Voice Profile', href: '/voice-profile', icon: UserCircle },
];
...
export function Sidebar() {
  ...
  return (
    <div className="relative z-10 flex h-full w-64 flex-col bg-slate-900">
      {/* Logo */}
      ...
      <div className="border-t border-slate-800 p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-medium text-white">{user?.email || 'Guest'}</p>
